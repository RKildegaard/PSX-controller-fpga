...
```sh
git clone git@github.com:RKildegaard/PSX-controller-fpga.git
cd PSX-controller-fpga
```
...
#### Commit your changes
```sh
git commit -m 'Starting PSX-controller-fpga'
